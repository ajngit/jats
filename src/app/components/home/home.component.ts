...
this.metaService.addTags([
  ...
  { property: 'og:image', content: 'https://www.jalalahmedtechnicalservices.com/assets/1.webp' },
  { property: 'og:url', content: 'https://www.jalalahmedtechnicalservices.com/' },
  ...
  { name: 'twitter:image', content: 'https://www.jalalahmedtechnicalservices.com/assets/1.webp' }
]);
